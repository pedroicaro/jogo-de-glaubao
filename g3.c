...
int ga3(int money,int price[],int profit[],int numGenerations){
	srand(time(NULL));
	printf("Start\n");
	...
	// int price[8] = {25,35,45,5,25,3,2,2};
	// int profit[8] 	=  {350,400,450,20,70,8,5,5};
	// int money = 104;

	printf("valor :%d",price[0]);
